 ...
 */
class AmazonBillingAddress implements ResolverInterface
{
  /**
  ...
  public function resolve(Field $field, $context, ResolveInfo $info, array $value = null, array $args = null)
  {
    ...
    $address = $this->getBillingAddress($amazonOrderReferenceId, $addressConsentToken, $cart);
    return $address;
  }
   ...
   * {@inheritdoc}
   */
  public function getBillingAddress($amazonOrderReferenceId, $addressConsentToken, $cart)
  {
    try {
