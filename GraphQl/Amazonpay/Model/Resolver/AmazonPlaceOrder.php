...
use Amazon\Payment\Model\QuoteLinkManagement;

/**
 * @inheritdoc
 */
class AmazonPlaceOrder implements ResolverInterface
{
    /**
     ...
     * @param QuoteLinkManagement $quoteLinkManagement
     */
    public function __construct(
        ...
        QuoteLinkManagement $quoteLinkManagement
    ) {
