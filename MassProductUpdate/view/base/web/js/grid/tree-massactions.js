define([
    'ko',
    'underscore',
    'Theshreyas_MassProductUpdate/js/grid/massactions'
], function (ko, _, Massactions) {
    'use strict';

    return Massactions.extend({
        defaults: {
            template: 'theshreyas_massproductupdate/grid/tree-massactions',
            submenuTemplate: 'ui/grid/submenu',
            theshreyassubmenuTemplate: 'theshreyas_massproductupdate/grid/submenu',
            selectProvider: '',
            modules: {
